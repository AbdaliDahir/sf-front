...
// ======================================================
// React translate passes the messages and format functions down the component
...
class IntlTranslator {
    ...
    // ------------------------------------
    public formatMessage (message, values?): string {
...
export const translate = new IntlTranslator();
