...
export default class EditServiceUserStep extends React.Component<Props, State> {
            ...
            <Row>
                <Col md={3}>
                    <FormGroup>
                        ...
                        <FormSelectInput name="act.civility" id="act.civility" value={civility}>
                            <option
