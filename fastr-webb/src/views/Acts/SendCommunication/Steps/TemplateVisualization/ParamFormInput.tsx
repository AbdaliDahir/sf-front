        ...
        case "boolean":
            return (<>
                ...
                <FormButtonGroupRadio name={param.name} id={`${param.type}_${param.name}`}
                                      ...
                                      onFieldValidation={props.updateValidArray(props.index)}>
                    <Button size="sm" color="primary" name={param.name} id={`${param.type}_${param.name}`} value="yes">
                        <FormattedMessage id="component.switch.yes"/>
                    </Button>
                    <Button size="sm" color="primary" name={param.name} id={`${param.type}_${param.name}`} value="no">
