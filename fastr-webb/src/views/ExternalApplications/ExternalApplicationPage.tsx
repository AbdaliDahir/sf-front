...
const ExternalApplicationPage = React.forwardRef((props : Props , ref) => {
    ...
    const motif: CaseQualification | undefined = useTypedSelector(state => state.casePage.motif);
    const userActivity: string | undefined = useTypedSelector(state => state.casePage.userActivity);
    ...
    const getParamValue = (param) =>{
        switch(param) {
            ...
            case "siren" : {
                return client!.data!.siren ? client!.data!.siren : "";
            }
            case "idc_nom" : {
                const {corporation, ownerPerson, ownerCorporation} = client.data!;
            ...
            case "DureeGel" : {
               ...
               const activityDuration = gelDurationApplicationSettings.durations.filter(duration => duration.activityCode === userActivity);
