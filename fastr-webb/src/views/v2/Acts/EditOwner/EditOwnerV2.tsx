...
import NewLegalResponsibleV2 from "./Steps/NewLegalResponsibleV2";
import NewOwnerV2 from "./Steps/NewOwnerV2";
import OwnerEligibilityV2 from "./Steps/OwnerEligibilityV2";
...
import BillingMethodFormV2 from "./Steps/BillingMethodFormV2";
import OwnerSearchV2 from "./Steps/OwnerSearchV2";
...
class EditOwnerV2 extends React.Component<Props, State> {
    ...
    public renderStep(): JSX.Element {
        switch (this.state.step) {
            case OwnerEditStep.SEARCH_OWNER:
                return <OwnerSearchV2 title={translate.formatMessage({id: "acts.holder.search.title"})}
            ...
            case OwnerEditStep.CREATE_OWNER:
                return <NewOwnerV2 title={translate.formatMessage({id: "acts.holder.new.title"})}
            ...
            case OwnerEditStep.FILL_BILLING_METHOD:
                return <BillingMethodFormV2 title={translate.formatMessage({id: "acts.billing.methods"})} forCTI={true}
            ...
            case OwnerEditStep.FILL_LEGAL_RESPONSIBLE:
                return <NewLegalResponsibleV2 saveData={this.saveData}
                                              validate={this.onValidateLegalResponsible}
                                              caseId={this.props.caseId}
                                              getValuesFromFields={this.props.getValuesFromFields}/>
    ...
    public render(): JSX.Element {
        if (!this.state.startAct) {
            return (
                <OwnerEligibilityV2 title={translate.formatMessage({id: "acts.owner.eligibility.title"})}
                                    client={this.props.client}
                                    idService={this.props.idService}
                                    startAct={this.startAct}
                                    notifyIneligibility={this.storeIneligibilityData}
                                    caseId={this.props.caseId}
...
export default withFormsy(EditOwnerV2);
