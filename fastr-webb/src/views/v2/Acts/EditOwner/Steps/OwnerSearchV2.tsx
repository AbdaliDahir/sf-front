...
class OwnerSearchV2 extends React.Component<Props, State> {
    ...
    public render(): JSX.Element {
        const clientId = this.props.client?.clientData?.id;
        const excludedIds = clientId ? [clientId] : [];
        return (
            <Container>
                ...
                <Row>
                    <Col>
                        <div className="mb-2 d-inline-flex float-right">
                            <Button id="ownerSearch.validate.button.id" size="sm" color="secondary"
...
export default connect(mapStateToProps)(OwnerSearchV2)
