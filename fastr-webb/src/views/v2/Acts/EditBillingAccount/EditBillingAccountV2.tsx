...
import BillingAccountUngroupV2 from "./BillingAccountUngroupV2";
import GroupBillingAccountV2 from "./GroupBillingAccountV2";
...
class EditBillingAccountV2 extends React.Component<Props, State> {
    ...
    public renderLinkedServices(): JSX.Element | JSX.Element[] {
        const linkedServices: Service[] = this.props.client.clientData!.services.filter(
    ...
    public renderServicesData(): JSX.Element {
        ...
        return (
            <Row>
                <Col md={6}>
                    <Card>
                        <CardHeader id="editBillingAccount.toggleBillingMethod.button.id"
                                    onClick={this.toggleBillingMethod}>
                            <Row>
                                <Col md={10}>
                                    Moyen de paiement actuel
                                </Col>
                                <Col md={2}>
                                    <i className={"icon icon-black float-right " + (collapseBillingMethod ? "icon-down" : "icon-up")}/>
                                </Col>
                            </Row>
                        </CardHeader>
                ...
                <Col md={6}>
                    <Card>
                        <CardHeader id="editBillingAccount.toggleLinkedServices.button.id"
                            ...
                            <Row>
                                ...
                                <Col md={2}>
                                    <i className={"icon icon-black float-right " + (collapseLinkedServices ? "icon-down" : "icon-up")}/>
                                </Col>
                            </Row>
                        </CardHeader>
    ...
    public getGroupEligibleServices = () => {
        return this.props.client.clientData!.services.filter(e => !ServiceUtils.isFixe(e)
    ...
    public renderAct(): JSX.Element {
        if (this.state.group) {
            return <GroupBillingAccountV2/>
        } else if (this.state.ungroup) {
            return <BillingAccountUngroupV2/>
        }
        return <React.Fragment/>
    }
        ...
        return (
            <Container id="EditBillingAccountADG.container.id">
                ...
                <ButtonGroup className={"d-flex justify-content-center align-items-center"}>
                    <Button id="editBillingAccount.displayGroupAct.button.id" color="primary" size={"sm"} active={group}
                            onClick={this.displayGroupAct}>Grouper</Button>
                    <Button id="editBillingAccount.displayUngroupAct.button.id" color="primary" size={"sm"} active={ungroup}
...
export default connect(mapStateToProps)(EditBillingAccountV2)
