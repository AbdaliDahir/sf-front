...
class BillingAccountUngroupV2 extends React.Component<Props, State> {
    ...
    public componentDidMount = async () => {
        ...
        const filteredServices: Service[] = this.props.client.clientData!.services.filter(
    ...
    public validateRibOnline = async (value: string) => {
        const storeData: ClientContextSliceState = this.props.client;
    ...
    public render(): JSX.Element {
        ...
        const dataClient: Client = this.props.client.clientData!;
        const data: Service | undefined = this.props.client.service;
                        ...
                        <Row>
                            <Col md={4}>
                                ...
                                <FormGroup>
                                    {this.state.selected === "ibanPreviousCF" ?
                                        <FormTextInput bsSize={"sm"} name="bankDetails.accountOwner" id="bankDetails.accountOwner"
                                                       value={titulaireName}
                                                       validations={{isRequired: ValidationUtils.notEmpty}}
                                                       disabled={this.state.disabled} readOnly={this.state.disabled}/> :
                                        <FormTextInput bsSize={"sm"} name="bankDetails.accountOwner"
                            ...
                            <Col md={8}>
                                ...
                                <FormGroup>
                                    ...
                                    {this.state.selected === "ibanPreviousCF" ? <FormTextInput bsSize={"sm"}
                                                                                               name="bankDetails.iban" id="bankDetails.iban"
...
export default connect(mapStateToProps)(BillingAccountUngroupV2)
