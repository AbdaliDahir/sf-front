...
class GroupBillingAccountV2 extends React.Component<Props, State> {
    ...
    public async componentDidMount() {
        ...
        const eligibleBillingAccountIdsResponse = await this.clientService.getEligibleBillingAccountIds(this.props.client.clientData!.id,this.props.client.serviceId!);
        this.setState({
...
export default connect(mapStateToProps)(GroupBillingAccountV2)
