...
class EditDeclaProV2 extends React.Component<Props, State> {
                                ...
                                <Row className={"d-flex justify-content-around"}>
                                    <Col>
                                        <FormGroup>
                                            <FormTextInput
                                                bsSize={"sm"}
                                                id="ownerPerson.siren" name="ownerPerson.siren"
...
export default connect(mapStateToProps)(EditDeclaProV2)
