...
import {Container, Row, UncontrolledPopover} from "reactstrap"
    ...
    return (
        <UncontrolledPopover target={props.target}
            ...
            <Container className={"AppExtContainer"}>
                ...
                <Row>
                    <button className="btn btn-secondary btn-sm mr-1" onClick={debranchFast}><img
                        className={"appExtImg"} alt={"FAST"} src={fastLogo}/></button>
                    <button className="btn btn-secondary btn-sm mr-1"><i className={"icon icon-close"}/></button>
                    <button className="btn btn-secondary btn-sm mr-1"><i className={"icon icon-close"}/></button>
                    <button className="btn btn-secondary btn-sm"><i className={"icon icon-close"}/></button>
                </Row>
                <Row className={"mt-1"}>
                    <button className="btn btn-secondary btn-sm mr-1"><i className={"icon icon-close"}/></button>
                    <button className="btn btn-secondary btn-sm mr-1"><i className={"icon icon-close"}/></button>
