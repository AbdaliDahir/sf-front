...
class QualificationSearchV2 extends Component<Props & RouteComponentProps, State> {
...
// tslint:disable-next-line:no-any
export default compose<any>(withRouter, connect(mapStateToProps, mapDispatchToProps))(QualificationSearchV2)
