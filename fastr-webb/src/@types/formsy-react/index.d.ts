...
declare module 'formsy-react' {
    ...
    declare class Formsy extends React.Component<FormsyProps, FormsyState> {
        ...
        public prevInputNames: any[] | null;
        ...
        public getModel: () => any;
        public getPristineValues: () => any;
        public setFormPristine: (isPristine: boolean) => void;
        public setInputValidationErrors: (errors: any) => void;
        public setFormValidState: (allIsValid: boolean) => void;
        public isValidValue: (component: any, value: any) => boolean;
        public isFormDisabled: () => boolean;
        public mapModel: (model: any) => any;
        public reset: (data?: any) => void;
        public resetInternal: (event: any) => void;
        public resetModel: IResetModel;
        public setValue: ISetInputValue;
        public runValidation: (component: InputComponent, value?: any) => {
            isRequired: boolean;
            isValid: boolean;
            error: any;
        };
        public attachToForm: (component: any) => void;
        public detachFromForm: (component: InputComponent) => void;
        public isChanged: () => boolean;
        public submit: (event: any) => void;
        public updateInputsWithError: IUpdateInputsWithError;
        public validate: (component: InputComponent) => void;
        public validateForm: () => void;
        public render: () => React.DetailedReactHTMLElement<{
            disabled: boolean;
            onError: any;
            hidden?: boolean;
            dir?: string;
