...
Then, on the server, regardless of the backend you use, you can read `index.html` into memory and replace `__OG_TITLE__`, `__OG_DESCRIPTION__`, and any other placeholders with listValues depending on the current URL. Just make sure to sanitize and escape the interpolated listValues so that they are safe to embed into HTML!
...
##### "Module not found: FASTRError: Cannot resolve 'file' or 'directory'"

If you get something like this:

```
remote: Failed to create a production build. Reason:
remote: Module not found: FASTRError: Cannot resolve 'file' or 'directory'
